    ...
    <div className={`space-y-3 ${className}`}>
        ...
        <Card className="bg-blue-50 border-blue-200">
          <CardContent className="p-4">
            ...
            <div className="mt-2 grid grid-cols-2 gap-4 text-xs text-blue-700">
              ...
              <div>
                <span className="font-medium">Otimizada:</span>{" "}
      ...
      <div className="text-xs text-gray-500 space-y-1">
        <div className="flex items-center">
          ...
          <span>
            Resolução máxima: {maxWidth}x{maxHeight}px
          </span>
        </div>
        <div className="flex items-center">
          <Info className="w-3 h-3 mr-1" />
          <span>
            Tamanho alvo: {maxSizeKB}KB • Qualidade: {Math.round(quality * 100)}
            %
          </span>
        </div>
      </div>
