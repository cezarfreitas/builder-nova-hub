      ...
      >
        {uploading ? (
          <div className="flex flex-col items-center">
            ...
            <p className="mt-2 text-sm text-gray-600">Enviando imagem...</p>
          </div>
        ) : (
          <>
            ...
            <div className="mt-4">
              <button
                ...
                className="cursor-pointer inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-ecko-red bg-red-50 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ecko-red"
              >
                Escolher arquivo
              </button>
              ...
              <p className="mt-1 text-xs text-gray-500">
                PNG, JPG, WebP até 5MB • {description}
              </p>
            </div>
          </>
        )}
