...
export function DynamicHead() {
  ...
  useEffect(() => {
    ...
    const canonicalUrl =
      getSetting("seo_canonical_url") || window.location.href;
    ...
    updateMetaTag(
      "twitter:description",
      getSetting("twitter_description") ||
        getSetting("og_description") ||
        getSetting("seo_description"),
    );
    updateMetaTag(
      "twitter:image",
      getSetting("twitter_image") || getSetting("og_image"),
    );
    ...
    if (schemaCompanyName) {
      const schemaData: any = {
        ...
        logo:
          getSetting("og_image") ||
          `${canonicalUrl || window.location.origin}/uploads/logo.png`,
        description:
          getSetting("seo_description") || "Rede de revendedores autorizados",
      };
