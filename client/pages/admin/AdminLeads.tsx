                      ...
                      <td className="px-3 py-2 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-1">
                          <button
                            ...
                            disabled={saving}
                            className="text-blue-600 hover:text-blue-900 p-0.5 rounded hover:bg-blue-50 disabled:opacity-50"
                          ...
                          <button
                            ...
                            disabled={saving}
                            className="text-red-600 hover:text-red-900 p-0.5 rounded hover:bg-red-50 disabled:opacity-50"
                            title="Excluir Lead"
                          >
                            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
