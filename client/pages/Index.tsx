          ...
          switch (section.id) {
            ...
            case 'benefits':
              return (
                <main key="benefits">
                  {/* Section Divider */}
                  <div className="bg-gradient-to-r from-transparent via-gray-600/10 to-transparent h-px mx-auto max-w-4xl opacity-30 hover:opacity-60 transition-all duration-1000 animate-in fade-in slide-in-from-left-32 slide-in-from-right-32" />
