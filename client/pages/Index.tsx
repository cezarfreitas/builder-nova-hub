...
export default function Index() {
  ...
  useEffect(() => {
    ...
    const activeTestimonials = content.testimonials.items.filter(
      (item) => item.is_active,
    );
        ...
        setTimeout(async () => {
          try {
            ...
            if (
              ...
              configResult.data.meta_tracking_enabled === "true"
            ) {
              console.log(
                "🎯 Disparando conversão para Meta - formulário enviado com sucesso",
              );
              ...
              trackButtonClick(
                `form_submission_${formData.storeType || "unknown"}`,
                "lead_conversion",
              );
            } else {
              console.log(
                "⏸️ Tracking de conversões desabilitado nas configurações",
              );
            }
  ...
  return (
    <>
      ...
      <main className="bg-black pb-4">
        ...
        <section
          ref={heroRef}
          className="h-screen relative flex flex-col justify-center items-center overflow-hidden bg-black text-white"
        >
          {heroLoading ? (
            ...
            <div className="text-center mt-8 sm:mt-12 px-4">
              <div className="bg-gradient-to-r from-ecko-red/10 to-ecko-red-dark/10 rounded-2xl p-4 sm:p-6 border border-ecko-red/20 backdrop-blur-sm max-w-2xl mx-auto">
                ...
                <Button
                  ...
                  className="group relative overflow-hidden bg-gradient-to-r from-ecko-red to-ecko-red-dark hover:from-ecko-red-dark hover:to-red-700 text-white px-6 sm:px-8 py-3 sm:py-4 font-bold text-sm sm:text-base shadow-lg hover:shadow-2xl hover:shadow-ecko-red/40 transition-all duration-300 hover:scale-105 uppercase tracking-wider rounded-lg w-full sm:w-auto"
                >
                  <span className="absolute inset-0 bg-gradient-to-r from-red-600 to-red-800 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
                  <span className="relative z-10 flex items-center">
                    <span className="hidden sm:inline">
        ...
        <section className="py-16 md:py-20 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10">
            ...
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <div className="inline-flex items-center bg-ecko-red/20 backdrop-blur-sm border border-ecko-red/30 rounded-full px-4 sm:px-6 py-2 sm:py-3 mb-4 sm:mb-6">
                <span className="text-ecko-red font-bold uppercase tracking-wider text-xs sm:text-sm">
        ...
        <section
          ...
          style={{
            ...(content.about?.background_type === "gradient"
              ...
              : content.about?.background_type === "image" &&
                  content.about.background_image
                ? {
                ...
                : {
                    backgroundColor:
                      content.about?.background_color || "#f9fafb",
                  }),
          }}
        >
          {/* Overlay */}
