...
import {
  getTestimonialsFromLpSettings,
  saveTestimonialsToLpSettings,
} from "../database/lp-settings-migration";

const router = express.Router();

// GET /api/testimonials-settings
async function getTestimonialsSettings(req: Request, res: Response) {
  try {
    ...
    console.log(
      "✅ Configurações dos testimonials carregadas:",
      Object.keys(testimonialsSettings),
    );
...
async function saveTestimonialsSettings(req: Request, res: Response) {
  try {
